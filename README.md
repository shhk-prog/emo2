...
| **Statistical Test** | Direction-aligned IUT, 1-sample/paired $t$, FDR (BH), Bootstrap CI | 5-fold GroupKFold CV, FDR (BH), LMM (Phase C E6), 20-derangements Permutation / Bootstrap CI | Paired family bootstrap 95% CI, paired Wilcoxon signed-rank test | Pre-registered Go/No-Go Gate, Pair-Bootstrap 95% CI (全仮説 CI 下限判定), FDR |
