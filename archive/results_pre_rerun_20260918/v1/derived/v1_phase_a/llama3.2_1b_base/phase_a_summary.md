# V1 Phase A Probing Summary Report: meta-llama/Llama-3.2-1B
...
- **Reader V Peak Layer**: Layer 14 ($R^2 = 0.327$)
- **Self V Peak Layer**: Layer 13 ($R^2 = 0.275$)
- **Peak Layer Displacement**: $|l^*_R - l^*_S| = 1$ layers

### Geometry Patterns Across Layers:
- **Alignable Geometry**: 13 / 17 layers (76.5%)
- **Shared Geometry**: 3 / 17 layers (17.6%)
...
- **Reader Condition Peak AUC**: Layer 10 ($	ext{AUC} = 0.966$)
- **Self Condition Peak AUC**: Layer 10 ($	ext{AUC} = 0.967$)
