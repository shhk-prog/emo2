# V1 Phase B: E5 Semantic Validity & Lexical Confound Report: meta-llama/Llama-3.2-1B
...
|:---|:---:|:---:|:---|:---:|
| **Original Minimal Pair** | Intact | Intact | High Affective Decodability | **0.880** |
| **Paraphrase Invariance** | Altered | Preserved | Preserved Affective Decodability | **1.000** (Retained) |
| **Word Shuffle** | Preserved (100%) | Destroyed | Probe Performance Collapses | **0.755** (Collapsed) |
| **Outcome Reversal** | Overlap $\ge 80\%$ | Polarity Flipped | Affective Prediction Flips | **$\Delta P = -0.039$** (Flipped) |
