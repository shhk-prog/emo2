# V1 Phase B: E5 Semantic Validity & Lexical Confound Report: mistralai/Mistral-7B-Instruct-v0.1
...
|:---|:---:|:---:|:---|:---:|
| **Original Minimal Pair** | Intact | Intact | High Affective Decodability | **0.938** |
| **Paraphrase Invariance** | Altered | Preserved | Preserved Affective Decodability | **0.997** (Retained) |
| **Word Shuffle** | Preserved (100%) | Destroyed | Probe Performance Collapses | **0.828** (Collapsed) |
| **Outcome Reversal** | Overlap $\ge 80\%$ | Polarity Flipped | Affective Prediction Flips | **$\Delta P = -0.007$** (Flipped) |
