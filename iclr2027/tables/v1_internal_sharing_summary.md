...
|:---|:---|:---|:---:|:---:|:---:|:---:|:---:|
| **Qwen 2.5 1.5B** | Base | Reader | L22 (0.81) | 0.378 (0.617) | L24 (0.89) | 0.130 (0.369) | 0.00 / 0.07 |
| **Qwen 2.5 1.5B** | Base | Self   | L22 (0.81) | 0.391 (0.626) | L26 (0.96) | 0.123 (0.356) | |
| **Qwen 2.5 1.5B** | Instruct | Reader | L15 (0.56) | 0.215 (0.467) | L17 (0.63) | 0.073 (0.301) | 0.07 / 0.11 |
| **Qwen 2.5 1.5B** | Instruct | Self   | L13 (0.48) | 0.285 (0.536) | L20 (0.74) | 0.075 (0.300) | |
| **Llama 3.2 1B** | Base | Reader | L14 (0.93) | 0.239 (0.490) | L4 (0.27) | 0.068 (0.288) | 0.20 / 0.00 |
| **Llama 3.2 1B** | Base | Self   | L11 (0.73) | 0.243 (0.494) | L4 (0.27) | 0.065 (0.282) | |
| **Llama 3.2 1B** | Instruct | Reader | L6 (0.40) | 0.317 (0.564) | L8 (0.53) | 0.113 (0.352) | 0.13 / 0.00 |
| **Llama 3.2 1B** | Instruct | Self   | L8 (0.53) | 0.355 (0.597) | L8 (0.53) | 0.106 (0.346) | |
| **Gemma 3 1B** | Base | Reader | L16 (0.64) | 0.331 (0.576) | L15 (0.60) | 0.043 (0.251) | 0.00 / 0.04 |
| **Gemma 3 1B** | Base | Self   | L16 (0.64) | 0.330 (0.576) | L16 (0.64) | 0.044 (0.254) | |
| **Gemma 3 1B** | Instruct | Reader | L12 (0.48) | 0.301 (0.552) | L12 (0.48) | 0.094 (0.323) | 0.08 / 0.36 |
| **Gemma 3 1B** | Instruct | Self   | L14 (0.56) | 0.375 (0.613) | L21 (0.84) | 0.088 (0.321) | |
| **OLMo 2 1B** | Base | Reader | L14 (0.93) | 0.418 (0.647) | L7 (0.47) | 0.089 (0.314) | 0.00 / 0.13 |
| **OLMo 2 1B** | Base | Self   | L14 (0.93) | 0.458 (0.677) | L9 (0.60) | 0.106 (0.338) | |
| **OLMo 2 1B** | Instruct | Reader | L7 (0.47) | 0.327 (0.573) | L11 (0.73) | 0.085 (0.307) | 0.00 / 0.27 |
| **OLMo 2 1B** | Instruct | Self   | L7 (0.47) | 0.352 (0.594) | L7 (0.47) | 0.086 (0.310) | |

## 2. Causal Mapping and Circuit Sharing (E3)

| Family | Variant | Reader Peak ($d^*$) | Self Peak ($d^*$) | Reader Mag ($\times 10^{-3}$) | Self Mag ($\times 10^{-3}$) | Spearman $\rho_{\text{rank}}$ | Mean Cosine |
|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|
