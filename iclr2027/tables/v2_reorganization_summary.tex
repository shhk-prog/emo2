...
\midrule
H1a: Geometry Reorganization   & Reader Procrustes Distortion           & 0.353    & [0.330, 0.370]     & < 0.001  & \checkmark Supported   \\
...
H2: Sharing Reorganization     & Valence $\Delta\text{Sharing}$         & -0.082   & [-0.105, -0.060]   & < 0.001  & \checkmark Supported   \\
H2: Sharing Reorganization     & Arousal $\Delta\text{Sharing}$         & -0.055   & [-0.065, -0.045]   & < 0.001  & \checkmark Supported   \\
H3: Causal Relocation          & Post-training LMM Slope $\beta$        & 0.142    & [0.085, 0.199]     & < 0.001  & \checkmark Supported   \\
H4: Distribution Recovery      & Matched-Plain Recovery AUC             & 0.720    & [0.680, 0.760]     & < 0.001  & \checkmark Supported   \\
\bottomrule
\end{tabular}
\vspace{1ex}
\begin{minipage}{\linewidth}
\footnotesize
\textbf{Note:} 全ての事前登録仮説（H1--H4）において 95\% CI がゼロを跨がず、FDR補正後 $q < 0.001$ で支持された。事後学習に伴う感情潜在空間の幾何学的歪み、因果部位の深層化、タスク共有度の分化、および介入による分布回復能が堅牢に証明された。
\end{minipage}
\end{table}
